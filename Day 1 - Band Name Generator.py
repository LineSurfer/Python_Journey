...
while True:
    ...
    time.sleep(0.3)  # Delay before asking for the first name
    ...
    time.sleep(0.3)  # Delay before acknowledging the name

    typewriter_print("\nGreat! Hello " + first_name +
                     "! That's a beautiful name.\n")

    time.sleep(0.3)  # Delay before asking for the city name

    typewriter_print("\nIn what city did you grow up?\n")
    city_name = input()

    time.sleep(0.3)  # Delay before acknowledging the city name
    ...
    time.sleep(0.3)  # Delay before displaying the final message
